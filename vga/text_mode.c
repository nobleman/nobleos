...
void txtvga_init()
{
    ...
    // At 0x410 is bios information, about monitor type (monachromate or color)
    volatile u16int* monitor_type = (volatile u16int*) 0x410;

	if ( ( *monitor_type & 0x30 ) == 0x30 )
...
void txtvga_puts(const char* str)
{
